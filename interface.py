...
class Font:
    ...
    @classmethod
    def set_dimfactor(cls):
        cls.f25 = pygame.font.SysFont( fontname, E(25*font_factor))
        cls.f30 = pygame.font.SysFont( fontname, E(30*font_factor))
        cls.f50 = pygame.font.SysFont( fontname, E(50*font_factor))
        cls.f70 = pygame.font.SysFont( fontname, E(70*font_factor))
        cls.f100 = pygame.font.SysFont(fontname, E(100*font_factor))
...
class Interface:
    ...
    @classmethod
    def setup(cls, dim, win_title, FPS=30, scale_factor=1):
        # create dimension
        Dimension.f = scale_factor
        cls.dim = Dimension(scale(dim))
        
        Font.set_dimfactor()
        
        #create screen
        cls.screen = pygame.display.set_mode(cls.dim.window)
        cls.screen.fill(C.WHITE)
        pygame.display.set_caption(win_title)

        cls.FPS = FPS

        set_screen(cls.screen)

    @classmethod
    def check_quit(cls, pressed, events):
        for event in events:
            # check quit
